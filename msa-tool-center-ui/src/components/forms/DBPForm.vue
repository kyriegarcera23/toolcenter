        ...
        <b-steps
            ...
            <form ref="form0" class="formStyle"  @submit.prevent="checkValid('form0')">     
                ...
                <b-field :type="{ 'is-danger': false }">
                    <p class="control">
                        <span style="width: 165px;" class="button is-static">Correlated Events</span>
                    </p>
                    <b-input type="number" min="0" placeholder="Enter a number..." onkeydown="return event.keyCode !== 69" required v-model="siem.correlated_events" expanded></b-input>
                </b-field>    
                <b-field :type="{ 'is-danger': false }">  
                    <p class="control">
                ...
                <div class="columns" style="height: 40px;">
                    <div class="column">
                        <p class="menu-label p-t-10">TOP CORRELATION RULES</p>
                    </div>
                    <div class="column">
                ...
                <transition-group class="has-background-white is-paddingless" name="fade" tag="div">
                    <div class="tile" style="padding: 10px 0 10px 0" v-for="index in siemTotal" :key="index" :id="'siem'+index">
                        <div class="tile p-r-10" style="max-width: 75px;">
                            <article class="tile is-child box has-background-dark" style="padding: 5px;">
                                <p class="subtitle has-text-centered has-text-white">{{ index }}</p>
                            </article>
                        </div>
            ...
            <b-step-item label="Finish" :clickable="isStepsClickable">
                ...
                <div style="height: 0; width: 0;">
                    <dbp-template :data="{date: dateFormat(date).toUpperCase(), html: html, siem: siem, correlation: correlation, sla: sla}"/>
                </div>
...
import dbpTemplate from './../templates/DBP'
    ...
    data() {
        return {
            editor: new Editor({
                ...
                <p>As of 4PM, 2 P4 tickets related to malware detection were created. Source IPs are for legitimacy verification and if proven malicious, it is advised to be blocked on the FireEye MPS. All tickets are endorsed to DBP for further verification.</p>
            ...
            email: {
                ...
                subject: `[MICTS][DBP][REPORTS & UPDATES][CONFIDENTIAL][LOW] SOC Daily Digest`
            },
            sla: {
                percentage: 100,
                tickets: {
