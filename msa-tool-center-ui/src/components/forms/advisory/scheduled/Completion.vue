            ...
            <b-step-item label="Details" :clickable="isStepsClickable">
                ...
                <div class="columns m-t-20">
                    <div class="column is-8 is-offset-2">
                        ...
                        <b-field horizontal label="Advisory" :label-position="labelPosition" custom-class="is-small">
                            <span class="is-size-7">{{ data.header.b }} - {{ data.header.c.join(' - ') }}</span>
                        </b-field>
                ...
                <div class="columns m-t-20">
                    <div class="column is-10 is-offset-1">
                        <p class="menu-label p-b-10" style="border-bottom: 1px solid #dadada">COMPLETION DETAILS</p>

                        <b-field horizontal label="Result" custom-class="is-small">
                            <b-field id="application">
                                <b-radio v-model="data.advisory_data.activity_result" v-for="(value, index) in activity_results" :key="index"
                                    size="is-small"
                                    class="impact-radio"
                                    :native-value="value">
                                    <span>{{ value }}</span>
    ...
    watch: {
        activity_result: {
            ...
            handler: function(newVal, oldVal) {
                oldVal;  
                this.data.advisory_data.activity_result = newVal
            }
        }
    },
    created() {
