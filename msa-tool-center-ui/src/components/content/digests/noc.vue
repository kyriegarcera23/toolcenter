        ...
        <div class="columns">
            ...
            <div class="column is-auto">
                ...
                <div class="is-pulled-right m-b-10">
                    <button v-if="$parent.$parent.canDo('create-daily-digest')"  class="button is-info is-small" @click="$emit('addDigest', active_client)" >
                        <plus></plus>
...
export default {
    data() {
        return {
            active_client: this.$route.params.active_client || 'UBP',
            clients: [
                {
                    code: "UBP",
                    description: "UnionBank of the PH",
                    category: "NOC"
                }
            ],
